...
const projectsCollection = defineCollection({
  ...
  schema: z.object({
    ...
    /** Category for filter (e.g. Backend, Infra, Data) */
    category: z.string().optional(),
    
    /** Tags for filter (in addition to techStack) */
...
const blogCollection = defineCollection({
  ...
  schema: z.object({
    ...
    /** Category for filter (e.g. Backend, Frontend, Notes) */
    category: z.string().optional(),
    
    /** Tags for categorization and filter */
    tags: z.array(z.string()).optional(),
 ...
 */
/**
 * About (Singleton) Collection
 *
 * Single-page about content: intro and resume in Markdown.
 */
